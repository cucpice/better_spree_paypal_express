...
module Spree
  class Gateway::PayPalExpress < Gateway
    ...
    def purchase(amount, express_checkout, gateway_options={})
      ...
      billing = ActiveMerchant::Billing::Response.new(false, 'Error! response seems invalid')
      if pp_response.success?
        ...
        billing = ActiveMerchant::Billing::Response.new(true, pp_response.to_hash)
      else
        billing = ActiveMerchant::Billing::Response.new(false, pp_response.to_hash)
      end
      billing
    end
